...
class FlutterpluginBixolon {
  ...
  static const String namespace = 'flutter_plugin_bixolon';
  ...
  FlutterpluginBixolon._() {
    _channel.setMethodCallHandler((MethodCall call) {
      _methodStreamController.add(call);
    });
  }

  static FlutterpluginBixolon _instance = new FlutterpluginBixolon._();

  static FlutterpluginBixolon get instance => _instance;
